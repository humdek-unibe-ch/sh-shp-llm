...
/**
 * Builds sidebar menu data for the unified LLM admin layout.
 * Each module view calls this to render the shared shell with correct
 * active state and ACL-based visibility.
 */
class LlmAdminLayoutHelper
{
    private static $menuDefinitions = [
        [
            'keyword' => 'sh_module_llm',
            'icon' => 'fa-cog',
            'fallbackLabel' => 'Settings',
        ],
        [
            'keyword' => 'moduleLlmAdminConsole',
            'icon' => 'fa-comments',
            'fallbackLabel' => 'Conversations',
        ],
        [
            'keyword' => 'moduleLlmScript',
            'icon' => 'fa-code',
            'fallbackLabel' => 'Scripts',
        ],
        [
    ...
    {
        return __DIR__ . '/tpl/llm_admin_layout.php';
    }
