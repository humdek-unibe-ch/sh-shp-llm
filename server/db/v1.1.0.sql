...
(get_style_id('llmFormRecord'), get_field_id('llm_context'), '', 'Prompt template sent to the LLM. Supports {{field_name}} interpolation with submitted form values. Example: "The user''s name is {{name}}. Provide a personalized greeting."'),
...
(get_style_id('llmFormRecord'), get_field_id('llm_result_panel'), 'card', 'Panel type for displaying the LLM result: default (inline), card (Bootstrap card), modal (dialog), collapse (collapsible).'),
...
(get_style_id('llmFormLog'), get_field_id('llm_context'), '', 'Prompt template sent to the LLM. Supports {{field_name}} interpolation with submitted form values.'),
...
(get_style_id('llmFormLog'), get_field_id('llm_result_panel'), 'card', 'Panel type for displaying the LLM result.'),
