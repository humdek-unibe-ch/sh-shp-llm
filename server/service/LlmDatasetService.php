...
class LlmDatasetService extends BaseLlmService
{
    ...
    public function toCaseType($execution_profile) { if (in_array($execution_profile, array('chat_runtime', 'therapy_chat_runtime', 'therapy_draft_runtime', 'therapy_summary_runtime'), true)) return 'chat_case'; if ($execution_profile === 'form_runtime') return 'form_case'; if ($execution_profile === 'script_runtime') return 'script_case'; return 'text_only_case'; }
